...
import com.livetyping.utils.utils.compat.CompatUtils;
...
public class SpannableUtils {
    ...
    public static Spannable getAbsoluteSizeSpan(Context context, String string, int dimenInDp) {
        SpannableString spannable = new SpannableString(string);
        spannable.setSpan(new AbsoluteSizeSpan(DimenUtils.pxFromDp(context, dimenInDp)),
