...
public class ForegroundImageView extends ImageView {
  ...
  public ForegroundImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    final Drawable d = a.getDrawable(R.styleable.ForegroundLayout_FIV_foreground);
    foregroundPadding = a.getBoolean(R.styleable.ForegroundLayout_FIV_foregroundInsidePadding, false);

    backgroundAsForeground = a.getBoolean(R.styleable.ForegroundLayout_FIV_backgroundAsForeground, false);
