...
//        Timber.e("EndlessListener expand");
...
//        ViewCompat.animate(v).alpha(1).scaleX(1).scaleY(1).setDuration(DURATION_OF_ANIMATION)
...
//        ViewCompat.animate(v).alpha(0).scaleX(0).scaleY(0).setDuration(DURATION_OF_ANIMATION)
//                .setListener(new ViewPropertyAnimatorListenerAdapter() {
//                    @Override
//                    public void onAnimationEnd(View view) {
//
//                    }
//                }).start();
        Timber.e("EndlessListener collapse");
...
//            @Override
//            protected void applyTransformation(float interpolatedTime, Transformation t) {
//                Timber.e("EndlessListener applyTransformation");
//                if (interpolatedTime == 1) {
//                    Timber.e("EndlessListener interpolatedTime == 1");
//                    v.setVisibility(View.GONE);
//                } else {
//                    Timber.e("EndlessListener interpolatedTime != 1");
