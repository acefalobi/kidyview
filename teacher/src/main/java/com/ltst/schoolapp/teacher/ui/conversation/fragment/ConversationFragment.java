...
import com.ltst.schoolapp.teacher.ui.conversation.ConversationScope;
...
//                .setOnMessageSwipeListener() // TODO: 31.01.17 (alexeenkoff)
        typingIndicator = new AtlasTypingIndicator(getContext())
                ...
                .setTypingActivityListener((typingIndicator1, active) -> messagesList.setFooterView(active ? typingIndicator1 : null));
...
//        if (this.conversation == null) {
    ...
    @Override public void initMessageComposer(LayerClient layerClient) {
        ...
        messageComposer.init(layerClient)
                ...
                .addAttachmentSenders(new FixedCameraSender(R.string.attachment_menu_camera, R.drawable.ic_attacment_camera, getActivity(), fileProviderAuthority))
                .addAttachmentSenders(new GalleryCloudSender(R.string.attachment_menu_gallery, R.drawable.ic_attachment_photo, getActivity()))
