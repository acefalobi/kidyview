...
public class DatedCheckActivity extends TeacherActivity implements HasFragmentContainer,
    ...
    @Override protected void addToTeacherComponent(TeacherComponent teacherComponent) {
        component = DaggerDatedChecksScope_DatedChecksComponent.builder()
                ...
                .datedChecksModule(new DatedChecksScope.DatedChecksModule(screenParams, getFragmentScreenSwitcher()))
                .build();
