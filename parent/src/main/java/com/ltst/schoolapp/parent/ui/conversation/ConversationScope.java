...
import com.ltst.schoolapp.parent.ui.conversation.fragment.ChatScope;
...
public @interface ConversationScope {
    ...
    @ConversationScope
    @Component(dependencies = ParentScope.ParentComponent.class, modules = ConversationModule.class)
