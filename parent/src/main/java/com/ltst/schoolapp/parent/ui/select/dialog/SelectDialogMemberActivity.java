...
import com.ltst.schoolapp.parent.ui.select.dialog.fragment.SelectMemberFragment;

import javax.inject.Inject;

public class SelectDialogMemberActivity extends ParentActivity implements HasFragmentContainer,
    ...
    @Override protected void addToParentComponent(ParentScope.ParentComponent teacherComponent) {
        this.component = DaggerSelectDialogMemberScope_SelectDialogMemberComponent.builder()
                .parentComponent(teacherComponent)
