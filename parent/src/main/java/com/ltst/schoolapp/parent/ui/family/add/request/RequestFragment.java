...
public class RequestFragment extends CoreFragment implements RequestContract.View {
    ...
    protected void onCreateComponent(HasSubComponents rootComponent) {
        AddMemberScope.AddMemberComponent component = (AddMemberScope.AddMemberComponent) rootComponent.getComponent();
        component.fragmentComponent(new RequestScope.RequestModule(this, this, getArguments())).inject(this);
    }
    ...
    @Override public void bindFindedMmeber(Member member) {
    ...
    @Override public void bindNewMember(String email) {
    ...
    public static final class Screen extends FragmentScreen {
        ...
        public static final String KEY_SCREEN_STATUS = "RequestFragment.Screen.ScreenStatus";

        private final int screenStatus;

        public Screen(@RequestPresenter.ScreenStatus int screenStatus) {
        ...
        @Override protected void onAddArguments(Bundle arguments) {
            ...
            arguments.putInt(KEY_SCREEN_STATUS, screenStatus);
        }
    }
